...
{
    public class DomcumentAttributes : IDictionary<string, string>, IEnumerable<KeyValuePair<string, string>>
    {
        #region constructors
        public DomcumentAttributes()
        {
        ...
        public DocumentAttributes Clone()
        {
            DocumentAttributes clone = new DocumentAttributes();
