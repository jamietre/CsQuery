...
The code for pulling source HTML from URI sources has not been tested extensively, but work well enough in a few simple test cases. The tests do not cover exception handling and this part of the code probably needs some work. 
