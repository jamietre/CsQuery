...
The current release is 1.1.3.1 (July 23, 2012), a bugfix release. Please review the [change log](https://github.com/jamietre/CsQuery/blob/master/source/README.md) for details on this release. 
